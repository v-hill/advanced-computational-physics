...
try:
    ...
    import delauney_triangulation.triangulation_core.linear_algebra as linalg
    from delauney_triangulation.triangulation_core.triangulation_primitives import make_primitives
except:
